...
export function ProductCard({
  ...
  return (
    ...
    >
      {/* Discount Badge */}
      {discountPercent && (
        <span className="absolute top-3 left-3 z-20 bg-rose-600 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-md shadow-xs pointer-events-none">
          {discountPercent}%
        </span>
      )}
      ...
      <div className="w-full aspect-square mb-2.5 pointer-events-none">
        <ProductImage
      ...
      {/* Content */}
      <div className="flex flex-col flex-1 justify-between pointer-events-none">
        <div>
